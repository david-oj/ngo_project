...
const News = () => {
  const featuredArticle = {
    ...
    excerpt: 'After 18 months of construction and community collaboration, our newest education center has opened its doors to 400 children in the remote highlands of Guatemala.',
    date: 'March 15, 2024',
    location: 'Guatemala',
  ...
  const articles = [
    {
      ...
      excerpt: 'Our new mobile health clinic in Kenya has exceeded expectations, providing essential medical care to over 1,000 patients in its first month of operation.',
      date: 'March 10, 2024',
      location: 'Kenya',
    ...
    },
    {
      ...
      excerpt: '50 women from rural Bangladesh have completed our intensive 6-month business training program, with 85% launching their own small businesses.',
      date: 'March 5, 2024',
      location: 'Bangladesh',
    ...
    },
    {
      ...
      excerpt: 'Aid Pathways teams are on the ground providing emergency shelter, food, and medical supplies to earthquake survivors in southeastern Turkey.',
    ...
    },
    {
      ...
      excerpt: 'The completion of our latest water well project in Tanzania now provides clean, safe drinking water to an entire community of 5,000 people.',
    ...
    },
    {
      ...
      excerpt: 'We\'re excited to announce our new partnership with Universidad Nacional to enhance our teacher training programs across Central America.',
    ...
    },
    {
      ...
      excerpt: 'Learn about Sarah\'s incredible journey from corporate marketing to leading our women empowerment programs in rural communities.',
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden mt-16">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl opacity-90">Stay updated on our programs and impact worldwide</p>
        </div>
      </section>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {categories.map((category, index) => (
              <Button
                ...
                size="sm"
                className={index === 0 ? "bg-primary hover:bg-primary-dark" : ""}
              >
                {category}
              </Button>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover the latest developments from our programs around the world.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article, index) => (
              <Card key={index} className="group hover:shadow-ngo-medium transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-20 hero-gradient text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            ...
            />
            <Button 
              className="bg-accent hover:bg-accent-light text-accent-foreground font-semibold px-6"
            >
              Subscribe
            </Button>
          </div>
